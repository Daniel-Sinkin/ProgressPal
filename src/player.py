...
class Player:
        ...
        match rarity:
            ...
            case Rarity.Common:
                ...
                match self._rng.choice([1, 2, 3, 4], p=[1 / 3, 1 / 3, 1 / 6, 1 / 6]):
                    ...
                    case 2:
                        elem_scroll = (
                            self._habit_journaling_get_random_elemental_scroll()
                        )
                ...
                match self._rng.choice([1, 2, 3]):
                    case 1:
                        ...
                        match input_:
                            ...
                            case 2:
                                elem_scroll = input(
                                    "Enter an elemental scroll 'scroll_fire' 'scroll_earth' 'scroll_water' 'scroll_wind' 'scroll_void'"
                                )
                                if elem_scroll not in [
                                    "scroll_fire",
                                    "scroll_earth",
                                    "scroll_water",
                                    "scroll_wind",
            ...
            case Rarity.Rare:
                ...
                self._habit_journaling_roll_reward_rare()
            case Rarity.VeryRare:
    ...
    def _habit_journaling_roll_reward_rare(self):
